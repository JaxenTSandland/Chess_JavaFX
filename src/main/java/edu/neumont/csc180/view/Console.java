...
public class Console {
    ...
    public static void writeLn(String text, TextColor textColor, String text1, TextColor textColor1)
    {
        write(text, textColor);
        writeLn(text1, textColor1);
    }
    public static void writeLn(String text, TextColor textColor, String text1, TextColor textColor1, String text2, TextColor textColor2)
    {
        write(text, textColor);
        write(text1, textColor1);
        writeLn(text2, textColor2);
    }
    public static void writeLn(String text, TextColor textColor, String text1, TextColor textColor1, String text2, TextColor textColor2, String text3, TextColor textColor3)
    {
        write(text, textColor);
        write(text1, textColor1);
        write(text2, textColor2);
        writeLn(text3, textColor3);
    }


    public static void write(String text, edu.neumont.csc180.view.Console.TextColor textColor, String text1, edu.neumont.csc180.view.Console.TextColor textColor1)
    {
        write(text, textColor);
        write(text1, textColor1);
    }
    public static void write(String text, edu.neumont.csc180.view.Console.TextColor textColor, String text1, edu.neumont.csc180.view.Console.TextColor textColor1, String text2, edu.neumont.csc180.view.Console.TextColor textColor2)
    {
        write(text, textColor);
        write(text1, textColor1);
        write(text2, textColor2);
    }
    public static void write(String text, edu.neumont.csc180.view.Console.TextColor textColor, String text1, edu.neumont.csc180.view.Console.TextColor textColor1, String text2, edu.neumont.csc180.view.Console.TextColor textColor2, String text3, edu.neumont.csc180.view.Console.TextColor textColor3)
    {
        write(text, textColor);
        write(text1, textColor1);
        write(text2, textColor2);
        write(text3, textColor3);
    }
